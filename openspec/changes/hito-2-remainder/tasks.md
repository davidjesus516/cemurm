...
- [x] 3.1 Create `src/lib/preferences.js` + `src/hooks/usePreferences.js`: read-through `prefs:${userId}`, global/override/practice jsonb (D2) — read-only surface; mutation UI later
